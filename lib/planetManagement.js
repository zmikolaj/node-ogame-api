...
var planetManagement = {};

planetManagement.getBuildings = function(planetId) {
...
planetManagement.getFacilities = function(planetId) {
	return RequestPromise.post({
...
planetManagement.getResearch = function() {
	return RequestPromise.post({
...
planetManagement.getShips = function(planetId) {
	return RequestPromise.post({
...
planetManagement.getDefense = function(planetId) {
	return RequestPromise.post({
...
module.exports = planetManagement;